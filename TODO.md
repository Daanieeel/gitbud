...
- [x] improve auto-staging new changes (sometimes doesnt pick up new changes; often when changes are made to a file that is already staged -> new changes then remain unstaged)
