...
- [x] **Discard changes per-file** — `repo::discard_file` + "Discard Changes" in the file context menu (`FileList.tsx`). Per-hunk discard still open (depends on hunk-level staging plumbing above).
